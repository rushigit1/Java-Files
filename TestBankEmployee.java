...
public class TestBankEmployee {public static void main(String[] args)  {
...
public static void viewEmp(BankEmployee [] emp) {
	int x = 0;
	System.out.println("employee id :     "+emp[x].getempId());
	System.out.println("employee name :   "+emp[x].getempName());
	System.out.println("employee city :   "+emp[x].getCity());
	System.out.println("employee salary : "+emp[x].getSalary());
...
public static void deleteEmp(BankEmployee [] emp) {
	...
	System.out.println("employee id "+emp[j].getempId());
	System.out.println("employee name"+emp[j].getempName());
	System.out.println("employee city "+emp[j].getCity());
	System.out.println("employee salary "+emp[j].getSalary());
